...
| Dương Thị Ngân | Evidence & Rules | Audit source facts, decision plan, grounded output, evidence/provenance rules và test tương ứng | Source handoff đã chuẩn bị; chỉ tính hoàn thành cá nhân sau khi Ngân tự kiểm tra, commit trên nhánh `ngan/evidence-rules` và mở PR |
